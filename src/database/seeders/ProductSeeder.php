    ...
    public function run()
    {
        ...
        $productsData = [
            ...
            [
                ...
                'image' => 'strawberry.png', // ★修正: ファイル名のみを記述
                'season_names' => ['春']
            ],
            [
                'name' => 'オレンジ',
                ...
                'image' => 'orange.png', // ★修正: ファイル名のみを記述
                'season_names' => ['冬']
            ],
            [
                'name' => 'スイカ',
                ...
                'image' => 'watermelon.png', // ★修正: ファイル名のみを記述
                'season_names' => ['夏']
            ],
            [
                'name' => 'ピーチ',
            ...
            [
                ...
                'image' => 'muscat.png', // ★修正: ファイル名のみを記述
                'season_names' => ['夏', '秋']
            ],
            [
                'name' => 'パイナップル',
                ...
                'image' => 'pineapple.png', // ★修正: ファイル名のみを記述
                'season_names' => ['春', '夏']
            ],
            [
                'name' => 'ブドウ',
                ...
                'image' => 'grapes.png', // ★修正: ファイル名のみを記述
                'season_names' => ['夏', '秋']
            ],
            [
                'name' => 'バナナ',
                ...
                'image' => 'banana.png', // ★修正: ファイル名のみを記述
                'season_names' => ['夏']
            ],
            [
                'name' => 'メロン',
        ...
        foreach ($productsData as $data) {
            ...
            // 季節を関連付け
            $seasonIds = $seasons->whereIn('name', $data['season_names'])->pluck('id');
